...
const TwitterImageComponent: React.FC = () => {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
const InstagramImageComponent: React.FC = () => {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
const GitHubImageCOmponent: React.FC = () => {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
const LinkedInImageComponent: React.FC = () => {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
const UdemyImageComponent: React.FC = () => {
  return (
    <svg
...
const socialMediaImagesComponent = {
  Twitter: TwitterImageComponent,
  Instagram: InstagramImageComponent,
  Github: GitHubImageCOmponent,
  Linkedin: LinkedInImageComponent,
  Udemy: UdemyImageComponent,
};

export default socialMediaImagesComponent;
